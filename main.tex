...
\begin{lstlisting}
https://github.com/karthikyadav26/Audio-filtering/blob/main/codes/5.4.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
%
\begin{lstlisting}
https://github.com/karthikyadav26/Audio-filtering/blob/main/codes/5.5.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{figs/Frequency Response of Audio Filter.png}
